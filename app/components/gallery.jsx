...
export default function Gallery({ active }) {
  ...
  const technologies = [
    ...
    },
    {
      ...
      description: "A high-level programming language for web development and beyond.",
    },
    {
      name: "HTML",
    ...
    },
    {
      ...
      description: "A NoSQL database program using JSON-like documents with optional schemas.",
    },
    {
      name: "Docker",
    ...
    },
    {
      ...
      description: "A vector graphics editor and prototyping tool for UI/UX design.",
    },
  ];
  ...
  return (
    ...
    >
      <div ref={ref} className="container mx-auto px-4">
        <motion.h2
          className="mb-12 text-center text-3xl z-10 font-bold tracking-wider relative uppercase sm:text-4xl"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          {active === sections[2] && (
            <motion.span
              ...
              className="absolute z-[-10]  inset-0 left-[50%] transform -translate-x-[50%] bg-[#e45c22]/20"
            ></motion.span>
          )}
        </motion.h2>
        <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
          {technologies.map((tech, index) => (
            ...
            <div className="group-hover:opacity-100 flex-col items-center opacity-0 absolute z-10 top-[-120px]">
              <div className={`${nanum_pen_script.className} -mb-9 text-md w-[250px]`}>{tech.description}</div>
              <img
